    ...
    <MotionContainer>
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="w-1/3">
          ...
          saepe ducimus cumque dolor, doloremque, quo exercitationem atque
          molestiae quidem, dolores mollitia fugit aliquam blanditiis aut modi!
          Impedit, voluptatem ratione!
        </div>
      </div>
    </MotionContainer>
  );
